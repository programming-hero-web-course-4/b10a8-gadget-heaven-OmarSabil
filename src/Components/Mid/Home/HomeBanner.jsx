...
const HomeBanner = () => {
    return (
            <div className='md:pt-5'>
                <div className="bg-purple-600 rounded-2xl p-8 md:p-16 pb-[150px] mb-[200px] md:pb-60 md:mb-64 lg:pb-80 lg:mb-[400px] text-white w-fit mx-10 text-center">
                    <div className='md:mt-10 lg:mt-20 relative'>
