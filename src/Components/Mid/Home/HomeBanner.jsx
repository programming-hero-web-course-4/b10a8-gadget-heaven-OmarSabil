...
const HomeBanner = () => {
    return (
            <div className="bg-purple-600 rounded-2xl p-16 pb-80 text-white w-fit mx-10 mt-5 text-center">
                <div className='mt-20'>
                    ...
                    <div className='flex justify-center'>
                        <div className='w-9/12 p-5 bg-gray-100 bg-opacity-15 rounded-3xl border-2 border-white mx-auto mt-10 absolute'>
