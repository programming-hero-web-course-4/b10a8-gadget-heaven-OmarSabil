...
const StatsBanner = () => {
    return (
        <div>
            ...
            <h1 className="font-bold text-6xl text-center text-purple-700 bg-gray-200 my-20 shadow-2xl w-fit mx-auto p-5 rounded-xl border-2 border-purple-300">No Data To Show Statistics</h1>
        </div>
    );
};
