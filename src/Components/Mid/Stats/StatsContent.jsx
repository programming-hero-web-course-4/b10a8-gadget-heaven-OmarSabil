    ...
    return (
        <div>
            <div className="bg-purple-600 px-16 py-10 text-white text-center mt-20">
                    ...
                    <p className="w-2/3 py- mx-auto">Explore the latest gadgets that will take your experience to the next level. From small devices to the coolest accessories, we have it all.</p>
            </div>
